...
static NSString * const LFPhotoLayoutPhotoCellID = @"LFPhotoCell";

@interface LFPhotoLayout ()
@property (nonatomic, strong) NSDictionary *layoutInfo;
@end

@implementation LFPhotoLayout
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[LFPhotoLayoutPhotoCellID] = cellLayoutInfo;
...
{
    return self.layoutInfo[LFPhotoLayoutPhotoCellID][indexPath];
}
